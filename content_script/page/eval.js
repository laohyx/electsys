...
function fast_eval_interlock(eval_num){
    ...
    eval1 = Math.min(100, eval1 + 1);
    eval2 = Math.min(10, eval2 + 1);
    jQuery("#sText_1_2_handleImage").parent().css("left",eval1 / 101 * width1 + "px");
    jQuery("#sText_1_3_handleImage").parent().css("left",eval1 / 101 * width1 + "px");
    jQuery("#sText_2_1_handleImage").parent().css("left",eval2 / 11 * width2 + "px");
